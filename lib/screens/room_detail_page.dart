...
class _RoomDetailsPageState extends State<RoomDetailsPage>
  ...
  Future<void> _playWithSystemPlayer(BuildContext context, String youtubeId) async {
    try {
      // Método 1: Intent explícito para reproducir video (Android)
      if (Platform.isAndroid) {
        // Primero intentamos con un intent de VIDEO directo
        final Uri videoUri = Uri.parse("https://www.youtube.com/watch?v=$youtubeId");
      ...
      if (Platform.isAndroid) {
        ...
        final uriLaunch = Uri.https('www.youtube.com', '/watch', {'v': youtubeId});
        await launchUrl(
            uriLaunch,
                  ...
                  children: [
                                            ...
                                            children: [
                                              ...
                                              Container(
                                                ...
                                                child: IconButton(
                                                  ...
                                                  onPressed: () {
                                                    Clipboard.setData(
                                                      const ClipboardData(text: '86622488'),
                                                    );
                                                    ScaffoldMessenger.of(context).showSnackBar(
                                                      const SnackBar(
                                  ...
                                  GestureDetector(
                                    onTap: isUploading ? null : () async {
                                      ...
                                      final XFile? image = await picker.pickImage(
                                        ...
                                        maxWidth: 1800, // Mayor resolución
                                        imageQuality: 90, // Mayor calidad
                                      );
                                        ...
                                        children: [
                                          ...
                                          ClipRRect(
                                            ...
                                            child: Image.file(
                                              ...
                                              fit: BoxFit.contain, // Cambiado a contain para mostrar completa
                                            ),
                                          ),
                    ...
                    Container(
                      ...
                      child: Container(
                        height: 56,
                        decoration: BoxDecoration(
                          gradient: isUploading || selectedImage == null
                              ? LinearGradient(
                          ...
                          borderRadius: BorderRadius.circular(12),
                          boxShadow: isUploading || selectedImage == null
                              ? null
                              : [
                            BoxShadow(
  ...
  Future<void> _submitJoinRequest(
    ...
    try {
      ...
      await FirebaseFirestore.instance.collection('notifications').add({
        ...
        'body': 'Tu solicitud para unirte a ${widget.roomData['name']} ha sido enviada. Te notificaremos cuando sea revisada.',
        'timestamp': FieldValue.serverTimestamp(),
        'read': false,
      });
  ...
  void _showJoinRoomDialog(BuildContext context, double price) {
    ...
    FirebaseFirestore.instance
      ...
      if (snapshot.docs.isNotEmpty) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Ya tienes una solicitud pendiente para esta sala'),
  ...
  Future<void> _launchYoutubeVideo(BuildContext context, String youtubeId) async {
  ...
  Future<bool> _isUserMember() async {
    ...
    try {
      ...
      final userRoomDoc = await FirebaseFirestore.instance
          .collection('usuarios')
          .doc(userId)
          ...
          child: Column(
            ...
            children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          if (widget.roomData['creatorUid'] != null) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(content: Text('Información del creador no disponible')),
                            );
                          }
                        },
                        child: Row(
                            ...
                            FutureBuilder<DocumentSnapshot>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                if (snapshot.hasData && snapshot.data != null && snapshot.data!.exists) {
                                  ...
                                  final photoUrl = userData?['photo'] as String? ?? userData?['photoURL'] as String?;
              ...
              if (widget.roomData['mediaItems'] != null &&
                ...
                StatefulBuilder(
                  builder: (context, setState) {
                    final int itemCount = (widget.roomData['mediaItems'] as List).length;
                        ...
                        Container(
                          ...
                          child: PageView.builder(
                            ...
                            itemBuilder: (context, index) {
                              final item = (widget.roomData['mediaItems'] as List)[index];
                              ...
                              if (item['type'] == 'video' && item['youtubeId'] != null) {
                                ...
                                return GestureDetector(
                                  onTap: () => _launchYoutubeVideo(context, youtubeId),
                                  child: Stack(
              ...
              Row(
                ...
                children: [
                  Text(
                    'Categoría: ${widget.roomData['category'] ??
                        'Sin categoría'}',
