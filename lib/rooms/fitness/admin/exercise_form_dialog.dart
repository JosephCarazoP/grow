      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          DropdownButtonFormField<BenchExercise>(
            ...
            style: TextStyle(color: Colors.white),
            isExpanded: true, // Añade esta línea para permitir que el dropdown se expanda
            items: _benchExercises.map((exercise) {
              return DropdownMenuItem<BenchExercise>(
                value: exercise,
                child: Text(
                  '${exercise.name} (${exercise.muscleGroup})',
                  overflow: TextOverflow.ellipsis, // Añade esta línea para recortar texto largo
                ),
              );
            }).toList(),
            onChanged: (value) {
...
// Add this method for input decoration
        ...
        children: [
          Row(
            children: [
              ...
              SizedBox(
                  width: _selectedBenchExercise!.imageUrls.isNotEmpty ? 16 : 0),
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
